function  Spec = cyclic_spectrum(y,x,alpha,nfft,Noverlap,Window,opt,P)     
% Spec = cyclic_spectrum(y,x,alpha,nfft,Noverlap,Window,opt) 
...
%                   Spec = cyclic_spectrum(y,x,...,P) where P is a scalar between 0 and 1 
%
% --------------------------
